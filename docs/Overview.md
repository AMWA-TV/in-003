...
Custom Resource contains:

- Spec
- Status
   
Operator control loop watches the resource.

Operator updates managed objects such as:

- Deployments
- ConfigMaps
- Services

Changes are observed and reconciled continuously to maintain the desired state.
